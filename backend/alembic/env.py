"""Alembic environment configuration for Lorapp database migrations."""
...
from app.infrastructure.database.base import Base  # type: ignore
# These imports are required for Alembic autogenerate to detect all models
